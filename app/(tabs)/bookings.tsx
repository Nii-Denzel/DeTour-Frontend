...
import { Colors } from "../../constants/colors";
import { getBookings, Booking } from "../../utils/bookings";
import { useFocusEffect } from "@react-navigation/native"; // reload when tab is focused
...
export default function BookingsScreen() {
  ...
  // reload when screen/tab is focused
  useFocusEffect(
    useCallback(() => {
      load();
    }, [load])

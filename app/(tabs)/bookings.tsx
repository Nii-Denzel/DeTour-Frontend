...
//   <View className="bg-white rounded-2xl overflow-hidden mb-4 border border-gray-100 shadow-sm">
//     <Image
...
//         </Text>
//       )}
//       <Text className="text-gray-500 text-sm">👥 {booking.people} People</Text>
//       <View className="flex-row justify-between items-center mt-3 pt-3 border-t border-gray-100">
//         <Text className="font-bold text-base" style={{ color: Colors.green }}>
...
//         <Text className="font-bold text-xl text-gray-900">My Bookings</Text>
//       </View>
...
//             style={{
//               backgroundColor:
//                 activeTab === tab.key ? Colors.green : Colors.lightGreen,
//             }}
//           >
//             <Text
//               className="text-sm font-semibold"
//               style={{
//                 color: activeTab === tab.key ? Colors.white : Colors.green,
//               }}
//             >
//               {tab.label}
//             </Text>

...
//   const [selectedDate] = useState('May 25, 2025');
//   const [selectedTime] = useState('8:00 AM');
...
//     Alert.alert(
//       'Payment Initiated',
//       `You will receive a prompt on your MTN MoMo or Vodafone Cash number to complete payment of GHS ${total}.`,
//       [
//         {
//           text: 'OK',
...
//           </TouchableOpacity>
//           <Text className="font-bold text-lg text-gray-900">Book a Tour</Text>
//         </View>
//       </SafeAreaView>
...
//           {/* Attraction Summary */}
//           <View className="flex-row items-center mb-5 bg-gray-50 rounded-2xl p-3 gap-3">
//             <Image
...
//               <Text className="font-bold text-base text-gray-900">{attraction.name} Tour</Text>
//               <Text className="text-gray-500 text-xs">{attraction.location}</Text>
//             </View>
//           </View>

//           {/* Date & Time */}
//           <BookRow icon="📅" label="Select Date" value={selectedDate} />
//           <BookRow icon="🕗" label="Select Time" value={selectedTime} />

//           {/* People Selector */}
//           <View className="flex-row items-center justify-between py-4 border-b border-gray-100">
//             <View className="flex-row items-center gap-3">
//               <Text className="text-xl">👥</Text>
//               <Text className="text-base text-gray-700">Number of People</Text>
//             </View>
...
//               </TouchableOpacity>
//               <Text className="font-bold text-base w-4 text-center">{people}</Text>
//               <TouchableOpacity
...
//                 <Text className="text-xl">🧭</Text>
//                 <Text className="text-base text-gray-700">Tour Guide</Text>
//               </View>
//               <TouchableOpacity>
...
//                 style={{
//                   backgroundColor:
//                     selectedGuide === g.id ? Colors.lightGreen : 'transparent',
//                   borderWidth: selectedGuide === g.id ? 1.5 : 1,
//                   borderColor:
//                     selectedGuide === g.id ? Colors.green : Colors.border,
//                 }}
//               >
//                 <View className="flex-row items-center gap-3">
//                   <View
...
//                   </View>
//                   <View>
//                     <Text className="font-semibold text-sm text-gray-900">{g.name}</Text>
//                     <Text className="text-gray-400 text-xs">{g.title}</Text>
//                     <StarRating rating={g.rating} reviews={g.reviews} />
//                   </View>
//                 </View>
//                 <Text className="font-bold text-sm" style={{ color: Colors.green }}>
//                   GHS {g.pricePerGroup}{'\n'}
//                   <Text className="font-normal text-xs text-gray-400">Per Group</Text>
//                 </Text>
//               </TouchableOpacity>
//             ))}
//           </View>
...
//               <Text className="text-xl">💳</Text>
//               <Text className="text-base text-gray-700">Payment Method</Text>
//             </View>
...
//             <Text className="font-bold text-xl" style={{ color: Colors.green }}>
//               GHS {total}
//             </Text>
//           </View>
//         </View>
...
//             Pay with {paymentMethod === 'momo' ? 'MoMo' : 'Vodafone Cash'}
//           </Text>
//         </TouchableOpacity>
//       </View>
//     </View>
...
// const BookRow = ({ icon, label, value }: BookRowProps) => (
...
// const PaymentOption = ({ label, emoji, selected, onPress }: PaymentOptionProps) => (
//   <TouchableOpacity
//     onPress={onPress}
//     className="flex-1 flex-row items-center gap-2 py-3 px-4 rounded-xl"
//     style={{
...
//       style={{ color: selected ? Colors.green : Colors.gray }}
//     >
//       {label}
//     </Text>
//     <View
//       className="w-4 h-4 rounded-full ml-auto border-2 items-center justify-center"
//       style={{ borderColor: selected ? Colors.green : Colors.border }}
//     >
//       {selected && (
//         <View

...
//         <Text className="text-gray-500">Attraction not found</Text>
//       </SafeAreaView>
//     );
//   }
...
//               <Text className="text-xs text-gray-400 mb-1">Open</Text>
...
//             <View className="w-px bg-gray-200 self-stretch" />
//             <View className="items-center flex-1">
//               <Text className="text-xs text-gray-400 mb-1">Entry Fee</Text>
//               <Text className="text-xs font-semibold text-gray-700">
...
//           {/* About */}
//           <Text className="font-bold text-base text-gray-900 mb-2">About</Text>
...
//                   <View key={a} className="items-center w-16">
//                     <View className="w-12 h-12 rounded-2xl bg-gray-100 items-center justify-center mb-1">
//                       <Text className="text-xl">{AMENITY_ICONS[a] ?? "✓"}</Text>
//                     </View>
...
//           //onPress={() => router.push(`/book/${attraction.id}`)}
//           activeOpacity={0.88}
//         >
//           <Text className="text-white font-bold text-base">Book a Tour</Text>
//         </TouchableOpacity>
//       </View>
//     </View>
//   );
